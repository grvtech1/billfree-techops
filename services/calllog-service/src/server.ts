...
import { registerCallLogRoutes } from './routes.js';
import type { CallEventRepository } from './repository.js';
...
export function buildServer(deps: ServerDeps): FastifyInstance {
  ...
  registerMetrics(app, deps.serviceName ?? 'calllog-service');
  registerHealth(app, { readiness: deps.readiness });
  registerCallLogRoutes(app, { repo: deps.repo, jwt: deps.jwt });
